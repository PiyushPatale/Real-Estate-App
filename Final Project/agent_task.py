...
try:
    conn = mysql.connect(host = 'localhost', user = 'root', password = 'Piyush@2003', database = "project")
...
bg_wa = PhotoImage(file = "BG_agent_task_1.png")
...
def seller_page():
    ...
    bg = PhotoImage(file = "BG_agent_seller_1.png")  # BACKGROUND_SELLER
    ...
    city = Entry(root10, width = 30, fg = 'white', border = 0, bg = '#292F33', font = ('Microsoft YaHei UI Light', 15))  
    city.place(x = 205, y = 85)
        
    locality = Entry(root10, width = 30, fg = 'white', border = 0, bg = '#292F33', font = ('Microsoft YaHei UI Light', 15))  
    locality.place(x = 205, y = 131)
        
    
    area = Entry(root10, width = 21, fg = 'white', border = 0, bg = '#292F33', font = ('Microsoft YaHei UI Light', 15))  
    area.place(x = 205, y = 170)
        
    pincode = Entry(root10, width = 21, fg = 'white', border = 0, bg = '#292F33', font = ('Microsoft YaHei UI Light', 15))  
    ...
    # seller details   
    sname = Entry(root10, width = 21, fg = 'white', border = 0, bg = '#292F33', font = ('Microsoft YaHei UI Light', 15))  
    sname.place(x = 262, y = 490)
        
    smail = Entry(root10, width = 21, fg = 'white', border = 0, bg = '#292F33', font = ('Microsoft YaHei UI Light', 15))  
    ...
    # SUBMIT button
    button_submit = Button(root10, text = 'SUBMIT', width = 20, background = 'black', foreground = 'white', activebackground = 'black', activeforeground = 'grey', font = ('yu gothic ui', 15, 'bold'), border = 0, command = submit_seller_det).place(x = 250, y = 600)
...
def buyer_page():
    ...
    bg_br = PhotoImage(file = "BG_buyer_req_1.png") # BACKGROUND_BUYER_REQ
    label_br = Label(root7, image = bg_br)
    label_br.place(x = 0, y = 0)

    # CITY, LOCALITY, AREA
    global city, locality, area, yoc, var3, var4
    city = Entry(root7, width = 42, fg = 'white', border = 0, bg = '#292F33', font = ('Microsoft YaHei UI Light', 15))  # CITY SPACE
    city.place(x = 287, y = 183)
    
    locality = Entry(root7, width = 42, fg = 'white', border = 0, bg = '#292F33', font = ('Microsoft YaHei UI Light', 15))   # LOCALITY SPACE
    locality.place(x = 287, y = 223)

    area = Entry(root7, width = 42, fg = 'white', border = 0, bg = '#292F33', font = ('Microsoft YaHei UI Light', 15))  # AREA SPACE
    ...
    ptype_s = tk.Checkbutton(root7, variable = var1, onvalue = 1, offvalue = 0, text = "Sell", bg = "white" , command = s_clicked)  # SELL CHECK BOX
    ptype_s.place(x = 317, y = 313)
    ptype_s.config(font = ("yu gothic ui", 13))

    ptype_r = tk.Checkbutton(root7, variable = var2, onvalue = 1, offvalue = 0, text = "Rent", bg = "grey" , command = r_clicked)  # RENT CHECK BOX
    ptype_r.place(x = 372, y = 313)
    ...
    park_1 = tk.Checkbutton(root7, text = "Yes", variable = var1 , bg = "white" , command = p1_clicked) # PARKING -> YES
    park_1.place(x = 699, y = 361)
    park_1.config(font = ("yu gothic ui", 13))

    park_2 = tk.Checkbutton(root7, text = "No", variable = var2 , bg = "grey" , command = p2_clicked)  # PARKING -> NO
    park_2.place(x = 755, y = 361)
    ...
    def submit_buyer_req():
        ...
        if city.get() == '' or locality.get() == '' or area.get() == '' or pr_last.get() == '0' or no_bed.get() == '0':
            ...
            bg_bd = PhotoImage(file = "BG_buyer_details_1.png")
            ...
            # BUYER_DETAILS
            prop_id = Entry(root8, width = 11, fg = 'white', border = 0, bg = '#292F33', font = ('Microsoft YaHei UI Light', 15))  
            prop_id.place(x = 247, y = 459)

            durat = Entry(root8, width = 11, fg = 'white', border = 0, bg = '#292F33', font = ('Microsoft YaHei UI Light', 15))  
            ...
            buyer_name = Entry(root8, width = 30, fg = 'white', border = 0, bg = '#292F33', font = ('Microsoft YaHei UI Light', 15))  
            buyer_name.place(x = 247, y = 495)

            buyer_id = Label(root8, width = 20, fg = 'white', border = 0, bg = '#292F33', font = ('Microsoft YaHei UI Light', 20))  
            buyer_id.place(x = 600, y = 495)

            buyer_mail = Entry(root8, width = 30, fg = 'white', border = 0, bg = '#292F33', font = ('Microsoft YaHei UI Light', 15))  
            buyer_mail.place(x = 250, y = 535)

            dob = Entry(root8, width = 13, fg = 'white', border = 1, highlightbackground = 'black', bg = '#292F33', font = ('Microsoft YaHei UI Light', 15))  
            ...
            button = Button(root8, text = 'SUBMIT', command = submitl, width = 15, cursor = 'hand2', background= 'black', foreground= 'white', activebackground = 'black', activeforeground = 'grey', font = ('yu gothic ui', 15, 'bold'), border = 0)
            button.place(x = 295, y = 600)      
            root8.mainloop()


    # SUBMIT BUTTON
    button = Button(root7, text = 'SUBMIT', width = 18, cursor = 'hand2', background= '#E5E5E5', foreground= 'black', activebackground = '#E5E5E5', activeforeground = 'grey', font = ('yu gothic ui', 15, 'bold'), border = 0, command = submit_buyer_req)
...
button_seller = Button(root15, text = 'SELLER PAGE', width = 20, background = 'black', foreground = 'white', activebackground = 'black', activeforeground = 'grey', font = ('yu gothic ui', 17, 'bold'), border = 0, command = seller_page).place(x = 200, y = 545)
button_buyer = Button(root15, text = 'BUYER PAGE', width = 20, background = 'black', foreground = 'white', activebackground = 'black', activeforeground = 'grey', font = ('yu gothic ui', 17, 'bold'), border = 0, command = buyer_page).place(x = 730, y = 545)
